...
@endphp
    ...
    <a class="btn btn-primary btn-md" href="{{ route('pengeluaran.create') }}" role="button"><i class="fas fa-plus-circle"></i> Add File</a>
    <br/>
                ...
                <td>{{ $no++ }}</td>
                    ...
                    <td>
                        <form method="POST" action="{{ route('pengeluaran.destroy',$a->id) }}">
                            ...
                            <a class="btn btn-outline-warning" href="{{ route('pengeluaran.edit',$a->id) }}" title="klik untuk mengedit data">ubah</i></a>
